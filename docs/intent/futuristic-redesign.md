...
> **SUPERSEDED on branch `beta`** (2026-06-11) by `experience-rebuild.md` — owner chose a full
> experience-site rebuild. This doc still governs `alpha`/`main` while they remain the live site.
...
- **Success:** A visitor thinks _"if their site feels like this, imagine what they'd build for me"_ and reaches the contact CTA. Buttery on mobile.
